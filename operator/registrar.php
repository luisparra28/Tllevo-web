...
<html lang="en">
<head>
	<title>Tllevo : Registro Operador :</title>
	<meta charset="UTF-8">
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="post" accept-charset="utf-8" name="form_register" id="form_register" autocomplete="off">
					...
					<div class="wrap-input100 validate-input" data-validate ="Ingrese su Razon Social">
					...
					<div class="flex-m w-full validate-input" data-validate="Debe Aceptar los términos">
