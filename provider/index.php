...
if ($login->isUserLoggedIn() == true) {
   ...
   header("location: ../../tllevo-front/index_chofer.php");
...
<html lang="en">
<head>
	<title>Tllevo : Login Chofer :</title>
	<meta charset="UTF-8">
			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="post" accept-charset="utf-8" action="index.php" name="loginform" autocomplete="off">
					...
					<span class="login100-form-title p-b-26">
						Bienvenido<br>
						<span style="font-size: 18px;">Chofer</span>
					</span>
					<?php
					...
					<div class="text-center p-t-40">
						...
						<a class="hov1" style="font-size: 18px; font-weight: 600" href="../operator/">
							&nbsp;Operador
						</a>
					</div>
					...
					<div class="text-center p-t-20">
						...
						<a class="hov1" style="font-weight: 600" href="../operator/registrar.php">
							Registra aquí una Nueva
						</a>
					</div>
				</form>
			</div>
