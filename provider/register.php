...
$clie_nombre    = mysqli_real_escape_string($con,$_POST["user_name"]);
$clie_apellido  = mysqli_real_escape_string($con,$_POST["user_apellido"]);
$clie_rut       = mysqli_real_escape_string($con,$_POST["user_rut"]);
$clie_telefono  = mysqli_real_escape_string($con,$_POST["user_phone"]);
$clie_correo    = mysqli_real_escape_string($con,$_POST["email"]);
$clie_password  = password_hash($_POST["user_password"], PASSWORD_DEFAULT);
